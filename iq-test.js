document.addEventListener("DOMContentLoaded", () => {
    ...
    const questions = [
        ...
        { q: "7 + 3 = ?", options: ["9","10","11"], answer: "10" },
        { q: "8 - 4 = ?", options: ["3","4","5"], answer: "4" },
        { q: "6 * 3 = ?", options: ["16","18","20"], answer: "18" },
        { q: "9 / 3 = ?", options: ["2","3","4"], answer: "3" },
        { q: "5 + 7 = ?", options: ["11","12","13"], answer: "12" },
        { q: "15 - 6 = ?", options: ["8","9","10"], answer: "9" }
    ];
